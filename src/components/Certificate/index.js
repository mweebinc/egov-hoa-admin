...
const defaultProps = {
  ...
  details:
    "According to records kept in this office, the subject has no pending cases. The resident has known to me to be a GOOD MORAL CHARACTER and LAW-ABIDING CITIZEN of this community.",
};
    ...
    <div className="p-3">
      ...
      <div className="d-flex">
        <div className="text-center">
          {official.map((o) => {
            return (
              <div className="border p-3" key={o.id}>
                {o.officials.map((o) => (
                  <div className="text-nowrap">
                    <h6 className="m-0 fw-bold">{o.name}</h6>
                    <p
                      style={{
                        fontSize: "10px",
                      }}
        ...
        <div>
          ...
          <div className="p-4">
            ...
            <div className="d-flex mt-3">
              <div>
                <p>
                  Given this day, <span className="fw-bold">March 7, 2023</span>
                </p>
                <div className="text-center mt-5">
                  <p className="fw-bold text-decoration-underline mb-0">
                    {object.name}
                  </p>
                  <p className="mb-0">Signature over printed name</p>
                </div>
              </div>
              <div
      ...
      <div className="text-center">
        <p className="fst-italic">
          Note: Valid for three (3) months from the Date of Issue. Not Valid
          without Dry Seal.
        </p>
      </div>
    </div>
