 ...
 */
const boostrap = 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css';

function addContentInIframe(iframe, content, styles = [boostrap]) {
    return new Promise((resolve) => {
        ...
        const total = images.length + links.length + styles.length;
        const loaded = [];
